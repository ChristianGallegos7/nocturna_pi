...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/dashboard/n/css/main.css">
    ...
    <!-- <style>
        ...
        * {
        ...
        .especialidades__text h2 {
            font-weight: 800;
            border-bottom: 2px solid #19e9d9;
        }

        .especialidades__text p {
            margin-top: 20px;
            font-weight: 500;
            line-height: 30px;
        }
        ...
        .footer {
            width: 100%;
            height: 90px;
            background-image: url('/n/images/banner-bg.png');
            background-position: center;
            background-repeat: no-repeat;
            background-size: cover;
            text-align: center;
    ...
    <header class="header__section" id="header">
        <div class="nav__container">
            <nav class="nav animate__animated animate__fadeInDown">
                <img class="logo animate__animated animate__fadeInLeft" src="http://localhost/dashboard/n/images//logo.png" alt="IMAGEN">
        ...
        <div class="header__info">
            <div class="header__image">
                <img src="http://localhost/dashboard/n/images/img-1.png" alt="">
            </div>
